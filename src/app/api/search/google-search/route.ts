...
const g = {
  helper: {
    ...
    formatError: function (string: any) {
    ...
    return NextResponse.json(
      {
        ...
        message: 'Parameter "query" or "search" is required.',
      },
      { status: 400 }
    );
  }
    ...
    return NextResponse.json(
      {
        status: false,
        creator: siteConfig.api.creator,
        message: 'Failed to search with Google Search AI.',
        error: error.message,
      },
      { status: 500 }
    );
